  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4">
              ...
              <Link to="/journals" className="text-white font-medium border-b-2 border-purple-400 pb-0.5">Journals</Link>
            </nav>
          </div>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-6 w-full">
        <h2 className="text-2xl font-bold text-center mb-6">{gameLog.game_name}</h2>
        {/* Public sharing */}
        {isOwner && (
